...
import { Brain, Star, Sparkles, ShoppingCart, Heart, TrendingUp } from "lucide-react";
...
const SmartRecommendations = () => {
  ...
  const handleGetRecommendations = async () => {
    ...
    toast({
      ...
      description: "AI has found the best products for you based on your preferences."
    });
  };
    ...
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground">
          Let our AI find the perfect products tailored to your preferences and budget
        </p>
      </div>
